<script>
  ...
  $: _i18n_copyart_lang = $lang;
  $: L_copyArt = ($lang, t('btn.copyArt'));
</script>

<button class="tm-fab tm-tip" on:click={onClick} aria-label={L_copyArt} data-label={L_copyArt} title={L_copyArt} data-tutorial="copyart">

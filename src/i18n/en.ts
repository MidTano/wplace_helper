...
export const en: Translations = {
  ...
  'qr.confirm': 'Confirm',
  'qrmusic.supported': 'Supported: YouTube, TikTok, SoundCloud, Spotify',
  'qrmusic.ex.youtube': 'Example: https://youtu.be/VIDEO_ID',
  'qrmusic.ex.tiktok': 'Example: https://www.tiktok.com/@user/video/ID',
  'qrmusic.ex.soundcloud': 'Example: https://soundcloud.com/artist/track',
  'qrmusic.ex.spotify': 'Example: https://open.spotify.com/track/ID',
  'qrmusic.placeholder': 'Paste a track or video link',
  'qrmusic.place': 'Place',
  'qrmusic.add': 'Add',
  ...
  'settings.bm.colorsHint': 'Colors come from the auto-mode menu (RMB)',
  'settings.bm.multiColor': 'Paint with all selected colors',
  'settings.bm.ignoreWrong': 'Ignore wrong color',
  'settings.bm.bypassWguard': 'Disable WGuard template protection',
  'settings.bm.maskAsBM': 'Mask as BlueMarble',
  'settings.autobuy.plus30': 'Auto-buy +30 droplets',
  'settings.autobuy.plus30Hint': 'Buy the "+30 droplets" pack when more than 500 droplets are available',
  'settings.autobuy.plus5': 'Auto-buy +5 max charges',
  'settings.autobuy.plus5Hint': 'Buy the "+5 max charges" pack when more than 500 droplets are available',
  'settings.autobuy.toast.plus30': '+30 droplets purchased',
  'settings.autobuy.toast.plus5': '+5 max charges purchased',
  'settings.autobuy.toast.error': 'Auto-buy failed',
  'automode.legalBlock.title': 'Auto mode paused',
  'automode.legalBlock.body': 'Server returned status 451 (access restricted). Retrying in a few minutes.',
  ...
  'gallery.empty': 'The gallery is empty so far.',
  'gallery.load': 'Load',
  'gallery.untitled': 'Untitled art',
  'gallery.unknownAuthor': 'Unknown author',
  'gallery.retry': 'Retry',
  'gallery.tabs.aria': 'Gallery tabs',
  'gallery.tab.home': 'Home',
  'gallery.tab.mine': 'My arts',
  'gallery.tab.add': 'Add',
  'gallery.mine.empty': 'You have no published art yet.',
  'gallery.mine.hint': 'To add a work, go to the "Add" tab, create a token and publish your art.',
  'gallery.tab.users': 'Users',
  'gallery.form.token': 'Token',
  'gallery.form.tokenPlaceholder': 'Paste your token',
  'gallery.form.title': 'Title (optional)',
  'gallery.form.titlePlaceholder': 'Art title',
  'gallery.form.publish': 'Publish current art',
  'gallery.form.saving': 'Publishing…',
  'gallery.form.getToken': 'Get token',
  'gallery.form.getTokenHint': 'A Discord post will open with instructions and a token. Check you are logged into the correct account.',
  'gallery.success.publish': 'Published successfully',
  'gallery.error.publish': 'Publishing error',
  'gallery.error.missingFields': 'Enter your token',
  'gallery.action.like': 'Like',
  'gallery.action.unlike': 'Unlike',
  'gallery.action.block': 'Block',
  'gallery.action.unblock': 'Unblock',
  'gallery.action.view': 'Show on map',
  'gallery.action.loadRobot': 'Load',
  'gallery.action.delete': 'Delete',
  'gallery.users.title': 'Users',
  'gallery.users.liked': 'Liked',
  'gallery.users.blocked': 'Blocked',
  'gallery.users.hint': 'Save a list of authors to quickly mark favorite works and hide unwanted content.',
  'gallery.filter.likes': 'Liked authors',
  'gallery.filter.date': 'By date',
  'gallery.users.empty': 'No entries yet',
  ...
  'automenu.sort.count': 'Sort by amount',
  'automenu.sort.id': 'Sort by ID',
  'automenu.sort.countLabel': 'By amount',
  'automenu.sort.idLabel': 'By ID',
